...
public class SendFile extends javax.swing.JFrame {
    ...
    */
                ...
                while(!Thread.currentThread().isInterrupted()){
                    ...
                    switch(cmd){
                        ...
                        case "CMD_RECEIVE_FILE_ACCEPT":  // Format: CMD_RECEIVE_FILE_ACCEPT [Message]
                            ...
                            new Thread(new SendingFileThread(socket, file, sendTo, myusername, SendFile.this,main)).start();
                            break;
                        ...
                        case "CMD_SENDFILERESPONSE":
                            ...
                            */
                            ...
                            form.updateAttachment(false);
                            JOptionPane.showMessageDialog(SendFile.this, rMsg);
                            dispose();
                            break;
                    }
                }
    ...
    private void initComponents() {
        ...
        btnSendFile.setBackground(new java.awt.Color(255, 255, 255));
        btnSendFile.setForeground(new java.awt.Color(51, 51, 51));
